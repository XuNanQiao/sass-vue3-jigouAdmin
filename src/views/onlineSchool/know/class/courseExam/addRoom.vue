 ...
 * @LastEditors: 南桥几许
 * @LastEditTime: 2022-07-19 12:03:36
 * @FilePath: \organization\src\views\onlineSchool\know\class\courseExam\addRoom.vue
-->
<template>
  <BasicModal
    v-bind="$attrs"
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerTable, { reload }] = useTable({
        title: '',
        api: examClient.getVirtualRoomList,
        beforeFetch: (t: any) => {
          t.kindId = unref(kind);
        },
        fetchSetting: {
         ...
         * slots：自定义的插槽 */
        columns: [
          { title: '考场名称', dataIndex: 'name', align: 'left' },
          { title: '项目分类', dataIndex: 'kindName' },
          { title: '所属专业', dataIndex: 'courseName' },
        ],
