 ...
 * @LastEditTime: 2022-07-05 15:02:15
 * @LastEditors: 南桥几许
 * @Description: 
 * @FilePath: \organization\src\views\onlineSchool\know\course\audio\addCourse.vue
 * 
-->
<template>
  <BasicDrawer
      ...
      async function handleSubmit() {
        try {
          ...
          if (unref(isUpdate)) {
            ...
            courseClient.updateAudioTeach(data);
          } else {
            courseClient.addAudioTeach(data);
          }
