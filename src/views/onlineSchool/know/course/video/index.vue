 ...
 * @LastEditTime: 2022-07-10 14:20:20
 * @LastEditors: 南桥几许
 * @Description: 
 * @FilePath: \organization\src\views\onlineSchool\know\course\video\index.vue
 * 
-->
<template>
  <div>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function handleData(record: Recordable) {
        router.push(`/know/course/courseData?typeId=${record.id}&type=2&docType=3`);
      }
      /* 课程模考 */
      ...
      function handleEvaluate(record: Recordable) {
        router.push(`/know/score/stuComment?typeId=${record.id}&type=3`);
      }
      return {
        ...toRefs(state),
        activeKey,
