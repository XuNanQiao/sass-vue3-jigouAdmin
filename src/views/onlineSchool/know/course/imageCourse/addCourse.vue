 ...
 * @LastEditTime: 2022-07-05 15:02:05
 * @LastEditors: 南桥几许
 * @Description: 
 * @FilePath: \organization\src\views\onlineSchool\know\course\imageCourse\addCourse.vue
 * 
-->
<template>
  <BasicDrawer
  ...
  >
    <BasicForm @register="registerForm">
      ...
      <template #thumbnailIcon="{ model, field }">
        <Upload
          name="upload"
          list-type="picture-card"
          class="avatar-uploader"
          ...
          "
        >
          <img v-if="model.thumbnailIcon" :src="model.thumbnailIcon" alt="avatar" />
          <div v-else>
            <PlusOutlined />
            <div class="ant-upload-text">上传图片</div>
          </div>
      ...
      async function handleSubmit() {
        try {
          ...
          if (unref(isUpdate)) {
            ...
            courseClient.updateImageTextTeach(data);
          } else {
            courseClient.addImageTextTeach(data);
          }
